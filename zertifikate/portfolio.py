...
def enrich_positions(
    ...
    """
    # Lokale Importe um Zirkel-Imports zu vermeiden
    from zertifikate.ampel import compute_einzelampel, compute_zeitampel, combine
    ...
    for pos in portfolio.get("open", []):
        ...
        result["roll_pruefen"] = zeit.roll_pruefen
